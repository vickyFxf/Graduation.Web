    ...
    return (
      <div className="global-panel">
        ...
        <div className="nav-box">
          <Link to="" activeClassName="active" className="global-panel-item"><i className="iconfont icon-tongzhi"></i><div>通知</div></Link>
        ...
        <div className="exit-box">
          <a className="global-panel-item"><i className="iconfont icon-gengduo"></i></a>
        </div>
      </div>
    )
  }
