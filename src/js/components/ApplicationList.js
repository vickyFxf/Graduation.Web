        ...
        <div key={index}>
          {
            ...
            </span> : <Link to={item.link} onClick={this.toggle.bind(this, index, item)} className={classnames({ "thread-item": true, "active": this.state.bgColorIndex == index ? true : false })}>
                <div className="thread-item-avator avator">
                11
                            </div>
                <div className="thread-item-info">
    ...
    switch (e.title) {
      case "教师":
        return <div className="thread-item-wrapper">
          <i className="iconfont icon-yonghul"></i>
        </div>;
      case "学生":
        return <div className="thread-item-wrapper">
          <i className="iconfont icon-yonghul"></i>
