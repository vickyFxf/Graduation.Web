/*
 * @Author: VickyFan 
 * @Date: 2018-04-19 14:55:11 
 * @Last Modified by:   VickyFan 
 * @Last Modified time: 2018-04-19 14:55:11 
 */
/**
 * 文献综述
 */
...
export default class LiteratureReview extends React.Component {
    static contextTypes={  
        ...
        return(
            <div className="task-page margin-left-subpanel">
                <div className="task-title">
                    <h2>【文献综述】{this.state.mySubject.subName}</h2>
                </div>
                <div className="task-body">
                    ...
                    <div className="right">
                        <div className="box handleButton">
                            <button onClick={this.downTemplate.bind(this,'文献综述.doc')}>下载模版</button>
                            <form encType='multipart/form-data' action={'http://localhost:3000/MyDocument-Module/Upload/_id='+this.state.studentId+'&teacherId='+this.state.mySubject.creatUserId+'&_docType='+'文献综述'} method="post" target="hidden-iframe">
