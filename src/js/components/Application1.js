 ...
 * @Last Modified time: 2018-04-10 15:03:02
 */
  ...
  render() {
    return (
      <Layout>
        ...
        <Layout>
          <Sider width={200} style={{ background: '#fff', height: '20vh', }}>
            <Menu
              mode="inline"
            ...
            >
              ...
              {this.state.permissions == "2" ?
                <SubMenu key="sub2" title={<span><Icon type="team" />用户管理</span>}>
                  <Menu.Item key="10"><Link to="userListMgt" activeClassName="active">管理操作</Link></Menu.Item>
                </SubMenu>
                : ""}
